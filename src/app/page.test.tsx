...
//TODO: improve typing
const mockedUsePlanets = usePlanets as jest.MockedFunction<any>;
...
const mockPlanetsData = {
  ...
  results: [
    ...
    },
    {
      ...
      url: "http://example.com/planets/2/",
      created: "dreated_date",
      updated: "updated_date",
      edited: "edited_date",
      films: [],
...
describe('Home Component', () => {
  ...
  describe('Initial Render', () => {
    ...
    it('should show correct pagination info', () => {
      ...
      expect(screen.getByText('Showing 1-10 results of 60')).toBeInTheDocument();
    });
  });
  ...
  describe('Column Toggle Functionality', () => {
    it('should toggle column visibility', async () => {
      ...
      // Toggle a column
      const climateToggle = screen.getByRole('menuitemcheckbox', { name: /climate/i });
  ...
  describe('Modal Functionality', () => {
    it('should open modal with planet details when row is clicked', async () => {
      ...
      expect(screen.getByText('Tatooine', { selector: 'h2' })).toBeInTheDocument();
    });
  ...
  describe('Pagination Functionality', () => {
    it('should update page number when Next button is clicked', async () => {
      ...
      mockedUsePlanets.mockReturnValueOnce({ data: [], page: 1, totalPages: 3 });
    ...
    it('should update results info when page changes', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Showing 11-20 results of 60')).toBeInTheDocument();
      });
    });
  });
